...
#define TRACE_ENTER strm << std::string(++indent * 2, ' ') << "+ " << __func__ << ": " << object->VpiLineNo() << std::endl
#define TRACE_LEAVE strm << std::string(2 * indent--, ' ') << "+ " << __func__ << ": " << object->VpiLineNo() << std::endl
